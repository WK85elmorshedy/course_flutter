...
class Button extends StatelessWidget {
  String nextScreen, textButton;

  Button({required this.nextScreen, required this.textButton});

  @override
  Widget build(BuildContext context) {
    List<CourseData> data = [
      CourseData(data: '''Part 1 ( Java SE)
...
• one signal push notifications SDK''', imgaPath: "assets/images/Android.jpeg"),
      //insert IOS data
      CourseData(
          data: '''OOP refreshment
• Introduction
...
• Creating final project depends on attendees needs''',
          imgaPath: "assets/images/IOS.jpeg"),
      //full stack data
      CourseData(data: '''•HTML	
•HTML 5 
•CSS
•CSS3
•SASS
...
•agile
•Scrum
•Software development process''', imgaPath: "assets/images/fullStack.jpeg")
    ];
    ...
    return Container(
        ...
        child: ElevatedButton(
          onPressed: () {
            if (nextScreen == 'androidCourse') {
              Navigator.pushNamed(context, 'androidCourse',
                  //   nextScreen,

                  arguments: data[0]);
            } else if (nextScreen == 'iosCourse') {
              Navigator.pushNamed(context, 'androidCourse',
                  //   nextScreen,
